        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12" id="contenedor">
                  ...
                  <form method="post" id="form_roles" action="/admin/roles/delete/">
                    @method('POST')
                    @csrf
                  </form>
                  ...
                  <div class="modal-dialog " role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-footer" id="modal_footer_acciones">
                        ...
                        id="btn_eliminar" form="form_roles">Eliminar</button>
...
@section('scripts')
  ...
  <script type="text/javascript" src="/js/custom/crudroles.js"></script>
@endsection
