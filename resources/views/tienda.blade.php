...
<section class="pt-4">
      <div class="container p-0">
        <div class="row ">
          <!--sidebar-->
          <div class="d-sm-none d-md-block col-md-3 col-lg-3 pl-0">
            <!-- Filters -->
            <form class="mb-10 mb-md-0">
              <ul class="nav nav-vertical" id="filterNav">
                <li class="nav-item">
                  <!-- Toggle -->
                  <a class="nav-link font-weight-bold dropdown-toggle font-size-md border-bottom pl-0" data-toggle="collapse" href="#categoryCollapse">
                    Nuestras Marcas
                    <i class="right fas fa-angle-down"></i>
                  </a>

                  <!-- Collapse -->
                  <div class="collapse show mt-1" id="categoryCollapse">
          ...
          <div class="col-12 col-md-9 col-lg-9 ">
            <div class="row align-items-center justify-content-end mb-3 bg-gray rounded-top">
                ...
                <div class="container">
                  <div class="row justify-content-center">
                    <div class="col-12 col-md-4">
                      ...
                      <!-- Form group -->
                      <div class="form-group form-group-overflow mb-md-0 pl-4">
