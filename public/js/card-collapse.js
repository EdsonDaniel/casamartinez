    ...
    $("#btn-toCart").click( function(){
        ...
        if(productsInCart == null){
            ...
            for (var i = productsInCart.length - 1; i >= 0; i--) {
                if (productsInCart[i].id == idPresentation){
...
function createProductCart(id, cantidad){
    ...
    var html = '<li class="list-group-item" data-product=' 
             ...
             + '<!-- Image -->'
             + '<a href="/tienda/detalles-producto?product=' 
             + prod.producto_id +'_' + prod.id_presentacion +'">'
             ...
             + '<a class="text-body title-product-cart" '
             + 'href="/tienda/detalles-producto?product=' 
             + prod.producto_id +'_' + prod.id_presentacion +'">'
...
function createListCheckout(id, cantidad){
    ...
    var html = '<li class="list-group-item"> '
             ...
             + ' <div class="col-4 p-0"> '
             + ' <!-- Image --> '
             + ' <a data-cart-items="' + cantidad + '" '
             + 'href="/tienda/detalles-producto?product=' 
             + prod.producto_id +'_' + prod.id_presentacion +'">'
             + ' <img src="/storage/'+ prod.foto_url +'"  alt="Imagen Producto" class="img-fluid"> '
             + ' </a> '
             + ' </div> '
             + ' <div class="col"> '
             + '  '
